from src.data_ingestion.loader import load_pdf
from src.data_ingestion.preprocessor import split_Document as chunker_doc, get_embedding_function
...
if index_name not in pinecone.list_indexes():
    pinecone.create_index(name=index_name, dimension=embembed_query("test").shape[0], metric="cosine")
index = pinecone.Index(index_name)'''


# Load documents and ingest into Pinecone
docs = load_pdf("data/my_doc.pdf")
chunks = chunker_doc(docs)
#placeholder
